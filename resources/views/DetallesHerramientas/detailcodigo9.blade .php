    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo9/1.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo9/2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo9/3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo9/4.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo9/5.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">Carretilla 4.75 ft3 Neumática, bastidor tubular, Truper</h3>
                <div class="d-flex mb-3">
                </div>
                <h3 class="font-weight-semi-bold mb-4">$5850.00</h3>
                <p class="mb-4">Motor de 1900 W para cortes que requieren potencia</p>
                <p class="mb-4">Brazo telescópico para mayor capacidad de corte (80 mm alto y 310 mm ancho)</p>
                <p class="mb-4">Guía láser para cortes precisos</p>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active text-center" id="tab-pane-1">
                        ...
                        <p>Potencia	1,900 W (2 1/2 HP)</p>
                        <p>Diámetro del disco	10" (250 mm)</p>
                        <p>Diámetro de eje	5/8" (16 mm)</p>
                        <p>Capacidad de corte a 0°	310 mm x 80 mm</p>
                        <p>Corte en inglete 0° a 45°	Izquierda / Derecha</p>
                        <p>Corte en bisel izquierdo	0° a 45°</p>
                        <p>Tensión / Frecuencia	127 V / 60 Hz</p>
                        <p>Consumo	15 A </p>
                        <p>Ciclo de trabajo	50 minutos de trabajo por 20 minutos de descanso. Máximo diario 6 horas</P>
                        <p>Dimensiones (Base x Alto x Fondo)	50 cm x 62 cm x 77 cm</p>
                        <p>Peso	15 kg</p>
                        <p>Empaque individual	Caja</p>
                    </div>
                    <div class="tab-pane fade text-center" id="tab-pane-2">
                        <h4 class="mb-3">Información Addicional</h4>
                       <p><a href="https://www.truper.com/admin/descargables/manual/16869-04%20Instructivo.pdf" target="_blank">Manual</a></p>
                       <p><a href="https://www.truper.com/admin/descargables/diagrama/16869.pdf" target="_blank">Díagrama</a></p>
                       <p><a href="https://www.truper.com/ficha_tecnica_pdf/views/ficha-print.php?id=252727" target="_blank">Ficha Técnica</a></p>
                    </div>
                </div>
            </div>
        </div>
