    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        ...
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/4.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/5.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/6.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo4/7.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">Carretilla 4.5 ft3 gris Neumática, bastidor tubular, Pretul</h3>
                <div class="d-flex mb-3">
                </div>
                <h3 class="font-weight-semi-bold mb-4">$1050.00</h3>
                <p class="mb-4">Llanta neumática reforzada con rin de 3 aspas</p>
                <p class="mb-4">Concha de lámina espesor 0.7 mm</p>
                <p class="mb-4">Bastidor tubular calibre 18 (1.21 mm)</p>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active text-center" id="tab-pane-1">
                        ...
                        <p>Capacidad (Copeteada / Ras)	4 ft³ (113 L) / 2.3 ft³ (65 L)</p>
                        <p>Medidas de la concha	27" (69 cm) x 37" (94 cm) x 9" (22 cm)</p>
                        <p>Medidas de llanta	3" (8 cm) x 14" (36 cm)</p>
                        <p>Resistencia de carga	250 kg</p>
                        <p>Puente con un tornillo	Calibre 16 (1.5 mm)</p>
                        <p>Soporte	Calibre 16 (1.5 mm)</p>
                    </div>
                    <div class="tab-pane fade text-center" id="tab-pane-2">
                        <h4 class="mb-3">Información Addicional</h4>
                       <p><a href="https://www.truper.com/ficha_tecnica_pdf/views/ficha-print.php?id=252515" target="_blank">Ficha Técnica</a></p>
                    </div>
                </div>
            </div>
        </div>
