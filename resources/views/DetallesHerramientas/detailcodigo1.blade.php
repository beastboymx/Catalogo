    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/img/codigo1/1.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo1/2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/codigo1/3.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold">Pala cuadrada T-2000, puño "Y", Truper</h3>
                <div class="d-flex mb-3">
                </div>
                <h3 class="font-weight-semi-bold mb-4">$269.00</h3>
                <p class="mb-4">Cabeza de acero al carbono</p>
                <p class="mb-4">Mango de madera con puño en "Y" Comfort Grip</p>
                <p class="mb-4">Collar reforzado que proporciona un ensamble robusto</p>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active text-center" id="tab-pane-1">
                        ...
                        <p>Modelo T-2000</p>
                        <p>Puño	Comfort Grip, offset</p>
                        <p>Hombros	Rolados atrás</p>
                        <p>Espesor	1.3 mm
                        <p>Ancho de la cabeza	9 1/2" (24 cm)</p>
                        <p>Largo de la cabeza	19 5/8" (50 cm)</p>
                        <p>Largo total	40 3/4" (104 cm)</p>
                    </div>
                    <div class="tab-pane fade text-center" id="tab-pane-2">
                        <h4 class="mb-3">Información Addicional</h4>
                        <a href="https://www.truper.com/ficha_tecnica_pdf/views/ficha-print.php?id=3985">Ficha Técnica</a>
                    </div>
                </div>
            </div>
        </div>
