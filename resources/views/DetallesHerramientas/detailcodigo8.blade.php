    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/1.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/2.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/3.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/4.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/5.jpg" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/img/Herramienta/codigo8/6.jpg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">$1590.00</h3>
                <p class="mb-4">Llanta neumática reforzada con rin de 3 aspas, diseño robusto y resistente al desgaste, rodada con mayor estabilidad</p>
                <p class="mb-4">Concha de lámina espesor 0.7 mm</p>
                <p class="mb-4">Bastidor tubular calibre 16 (1.5 mm) con grips antiderrapantes</p>
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active text-center" id="tab-pane-1">
                        ...
                        <p>Capacidad (Copeteada / Ras)	4.75 ft³ (135 L)/ 2.5 ft³ (70 L)</p>
                        <p>Medidas de la concha	24" (60 cm) x 36" (91 cm) x 13" (32 cm)</p>
                        <p>Medidas de llanta	4" (10 cm) x 16" (41 cm)</p>
                        <p>Resistencia de carga	580 kg</p>
                        <p>Puente con doble tornillo	Calibre 18 (1.2 mm)</p>
                        <p>Soporte y tacón	Calibre 15 (1.7 mm)</p>
                    </div>
                    <div class="tab-pane fade text-center" id="tab-pane-2">
                        <h4 class="mb-3">Información Addicional</h4>
                       <p><a href="https://www.truper.com/admin/descargables/manual/724658-01.pdf" target="_blank">Manual</a></p>
                       <p><a href="https://www.truper.com/ficha_tecnica_pdf/views/ficha-print.php?id=608" target="_blank">Ficha Técnica</a></p>
                    </div>
                </div>
            </div>
        </div>
